...
const AVATAR_ITEMS: { category: string; name: string; isDefault: boolean; renderKey: string }[] = [
  ...
  { category: 'HAIR', name: '짧은 머리', isDefault: false, renderKey: 'hair:short' },
  { category: 'HAIR', name: '긴 생머리', isDefault: false, renderKey: 'hair:long' },
  ...
  { category: 'FACE', name: '함박웃음', isDefault: false, renderKey: 'face:laugh' },
  { category: 'FACE', name: '메롱', isDefault: false, renderKey: 'face:tongue' },
  ...
  { category: 'CLOTHES', name: '가디건', isDefault: false, renderKey: 'top:cardigan' },
  { category: 'CLOTHES', name: '원피스', isDefault: false, renderKey: 'top:dress' },
  ...
  { category: 'BOTTOM', name: '롱스커트', isDefault: false, renderKey: 'bottom:longskirt' },
  { category: 'BOTTOM', name: '레깅스', isDefault: false, renderKey: 'bottom:leggings' },
  ...
  { category: 'ACCESSORY', name: '귀걸이', isDefault: false, renderKey: 'accessory:earrings' },
  { category: 'ACCESSORY', name: '안대', isDefault: false, renderKey: 'accessory:eyepatch' },
]
